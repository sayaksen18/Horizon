     ...
     via-white to-teal-100 flex items-center justify-center px-4 sm:p-6'>
      ...
      border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
          <div>
           <video src={femaleVideo} className='w-full max-w-md rounded-2xl overflow-hidden shadow-xl' />
           </div>
           {/*Subtitle*/}
           {/*Timer Area*/}
           <div className='w-full max-w-md bg-white-border border-gray-200 rouned-2xl
           shadow-md p-6 space-y-5' >
            ...
            <div className='flex justify-center' ></div>
              <Timer timeLeft={60} totalTime={100}/>
           </div>
           <div className='h-px bg-gray-200'></div>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          className='flex items-center gap-4 mt-6'>
            <motion.button className='w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full
